...
def check_squats(image):
    fontface = cv2.FONT_HERSHEY_SIMPLEX
    global countdown_started, start_counter, total_time_remaining, total_squat, start_ymin, end_ymin, process_start, total_time, list_miny, process_finish, xMid, yMid, process_stand, raise_hand
    requests.packages.urllib3.disable_warnings()
